...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<form:form action="/partners/registration" method="post" modelAttribute="partner">
    ...
    <div class="form-group input-group">
        ...
        <form:input path="passwordConfirmation" class="form-control" placeholder="Repeat password" type="password"/>
    </div> <!-- form-group// -->                                      
    <div class="form-group">
        <button type="submit" class="btn btn-primary btn-block"> Create Account  </button>
    </div> <!-- form-group// -->      
    <p class="text-center">Have an account? <a href="/partners/login">Log In</a> </p>
    <p><form:errors path="partner.*"/></p>                                                           
</form:form>
</article>
</div> <!-- card.// -->
